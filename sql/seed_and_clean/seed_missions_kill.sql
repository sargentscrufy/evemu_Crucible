...
INSERT INTO qstKill (id, briefingID, name, level, typeID, important, storyline,
  ...
  (56001, 130400, 'Pirate Ambush',         1, 2, 0, 0, 25373, 1, 120000, 0, 0, 60000, 60, 0, 0),
  (56002, 130400, 'Retrieve the Reports',  1, 2, 0, 0, 3814,  1, 140000, 0, 0, 70000, 60, 0, 0),
  (56003, 130400, 'Hostage Rescue',        1, 2, 0, 0, 3810,  2, 160000, 0, 0, 80000, 60, 0, 0),
  (56004, 130400, 'Cut the Supply Line',   1, 2, 0, 0, 25373, 2, 150000, 0, 0, 75000, 60, 0, 0),
  (56005, 130400, 'Silence the Informant', 1, 2, 0, 0, 3814,  1, 180000, 0, 0, 90000, 60, 0, 0);
